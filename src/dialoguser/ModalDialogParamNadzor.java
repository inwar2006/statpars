 ...
 */
public class ModalDialogParamNadzor {
    static Stage dialogStage;
    private TextArea txtArea = new TextArea();
    private ControlBlock controlBlock = new ControlBlock();
    //посредник для обработки статистики
    private LinkedHashMap<String, String> userDatamap = new
        LinkedHashMap<>();
    private String nadFile = ""; //файл над.статистики
    private String bazaFile = "";//файл БД
    private String otdelFile = "";//файд отдела
    private String resultFile = "";//файл результата
    private String patternFile = "";//файл шаблона
    private String encode = "";//кодировка
    private final FileChooser fileDialog = new FileChooser();
    
    public ModalDialogParamNadzor(){        
     ...
     public LinkedHashMap<String, String> askParam(LinkedHashMap<String, 
        ...
        nadFile = userDatamap.get("Файл статистики");
        bazaFile = userDatamap.get("Файл БАЗА");
        ...
        Button btnParam4 = new Button("Выбрать");
        btnParam4.setMinWidth(120);
        ...
        TextField fieldParam4 = new TextField();
        ...
        grid.addRow(4, lblParam4, btnParam4, fieldParam4);
        grid.addRow(5, encodeParam, cbEncode, lblParam5);
        ...
        GridPane.setHalignment(btnParam4, HPos.LEFT);
        ...
        GridPane.setHalignment(fieldParam4, HPos.LEFT);
        GridPane.setHalignment(lblParam5, HPos.LEFT);
        ...
        btnParam0.setOnMouseClicked(e -> {
               nadFile = controlBlock.chooseF(fileDialog, dialogStage);
               fieldParam0.setText(nadFile);
        });
        ...
        btnParam1.setOnMouseClicked(e -> { 
            bazaFile = controlBlock.chooseF(fileDialog, dialogStage);
            fieldParam1.setText(bazaFile);
        });
        ...
        btnParam3.setOnMouseClicked(e -> {
            ...
            fieldParam3.setText(resultFile);
        });
    ...
    private void btnYes_Click(){
        dialogStage.close();
        userDatamap.put("Файл статистики", nadFile);
        userDatamap.put("Файл БАЗА", bazaFile);
