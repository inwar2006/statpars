 ...
 */
public class ModalDialogParamRoz {
    static Stage dialogStage;
    private TextArea txtArea = new TextArea();
    private ControlBlock controlBlock = new ControlBlock();
    private LinkedHashMap<String, String> userDatamap = 
            new LinkedHashMap<>();//посредник
    private String rozFile = ""; //файл р.статистики
    private String bazaFile = "";//файл БАЗА
    ...
    public LinkedHashMap<String, String> askParam(LinkedHashMap<String, 
        ...
        rozFile = userDatamap.get("Файл статистики");
        ...
        //обработка события нажатия мыши на клавишу btnNo
        ...
        btnParam0.setOnMouseClicked(e -> {
               rozFile = controlBlock.chooseF(fileDialog, dialogStage);
               fieldParam0.setText(rozFile);
        });
    ...
    private void btnYes_Click(){
        dialogStage.close();
        userDatamap.put("Файл статистики", rozFile);
